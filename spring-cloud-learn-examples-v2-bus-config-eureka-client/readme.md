...
//            HttpPost post = new HttpPost("http://192.168.10.27:18086/actuator/refresh");
            //使用bus 服务进行刷新
            HttpPost post = new HttpPost("http://192.168.10.27:18086/actuator/bus-refresh");
...
###### 		第一步启动：spring-cloud-learn-examples-v2-bus-eureka

​		访问地址：http://192.168.10.27:8761/

###### 		第一步启动：spring-cloud-learn-examples-v2-bus-config-eureka

​		访问地址：http://192.168.10.27:8888/application-dev.properties

###### 		第二步启动：spring-cloud-learn-examples-v2-bus-config-eureka-client
